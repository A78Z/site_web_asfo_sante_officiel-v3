// ---------------------------------------------------------------------------
// Archives des missions médicales ASFO — données partagées entre la page
// /archives et l'aperçu de la page d'accueil (ArchivesPreview).
// ---------------------------------------------------------------------------

export interface ArchiveSpecialty {
  name: string;
  count: number;
}
...
export interface ArchiveMission {
  ...
  imageUrl: string;
  summary: string;
  specialties: ArchiveSpecialty[];
}

export const archives: ArchiveMission[] = [
  {
