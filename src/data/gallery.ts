// ---------------------------------------------------------------------------
// Galerie photo ASFO — données partagées entre la page /gallery et
// l'aperçu de la page d'accueil (GalleryPreview).
// ---------------------------------------------------------------------------
